...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    volume_cube = volume_calculations_cube(3)
    assert_equal( 27, volume_cube)
  end

  def test_volume_of_sphere()
    volume_sphere = volume_calculations_sphere(2)
    assert_equal( 33.510321638291124, volume_sphere)
  end



  def test_fahrenheit_to_celsius()
    fahrenheit_to_celsius = temperature_conversion(5)
    assert_equal( -29.22222222222222, fahrenheit_to_celsius)
  end
